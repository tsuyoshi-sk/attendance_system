...
class DailySummary(Base):
    ...
    employee = relationship(
        "Employee", foreign_keys=[employee_id], back_populates="daily_summaries"
    )
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "clock_out_time": self.clock_out_time.isoformat()
...
class MonthlySummary(Base):
    ...
    # リレーション
    employee = relationship(
        "Employee", foreign_keys=[employee_id], back_populates="monthly_summaries"
    )
    approver = relationship("Employee", foreign_keys=[approved_by], post_update=True)
